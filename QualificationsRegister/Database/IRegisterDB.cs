...
namespace Ofqual.Common.RegisterAPI.Database
{
    public interface IRegisterDb
    {
        ...
        DbQualification? GetQualificationByNumber(string numberObliques, string numberNoObliques, string? numberAlphanumeric);
        DbQualificationPublic? GetQualificationPublicByNumber(string numberObliques, string numberNoObliques, string? numberAlphanumeric);
